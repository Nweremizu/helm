...
export function Modal({
  ...
  if (isMobile && !desktopOnly) {
    return (
      ...
      >
        <Drawer.Portal>
          <Drawer.Overlay className="fixed inset-0 z-50 bg-neutral-50 bg-opacity-10 backdrop-blur" />
          <Drawer.Content
    ...
    >
      <Dialog.Portal>
        <Dialog.Overlay
          ...
          id="modal-backdrop"
          className="animate-fade-in fixed inset-0 z-40 bg-neutral-50 bg-opacity-50 backdrop-blur-md"
        />
        <Dialog.Content
